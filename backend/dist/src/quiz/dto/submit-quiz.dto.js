...
__decorate([
    ...
    (0, class_validator_1.ArrayMinSize)(1, { message: 'At least 1 answer is required' }),
    (0, class_validator_1.IsInt)({ each: true, message: 'Each answer must be an integer index' }),
